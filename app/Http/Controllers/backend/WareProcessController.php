...
class WareProcessController extends Controller
{
    ...
    {
        $process = WareProcess::orderBy('created_at', 'desc')->paginate(30);
    ...
    public function create()
    {
        ...
        return view('backend.ware-process.create',compact('wares','products','users','status'));
    }
    ...
    public function edit($id)
    {
        if(!empty(WareProcess::find($id)))
        {
            ...
            return view('backend.ware-process.edit',compact('process','wares','products','users','status'));
        }
        return redirect()->route('ware-process.index');
    }
